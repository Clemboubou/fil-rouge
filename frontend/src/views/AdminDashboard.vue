            ...
            <div class="card-body">
              <div class="flex items-center">
                ...
                <div class="ml-4">
                  ...
                  <p class="text-2xl font-bold text-gray-900">{{ stats?.totalQuizzes || 0 }}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-body">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="mt-1 text-sm text-gray-600">Oversee all quizzes and content</p>
                </div>
            ...
            <div class="card-body">
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="mt-1 text-sm text-gray-600">View detailed analytics</p>
                </div>
            ...
            <div v-if="stats?.recentAttempts?.length" class="space-y-4">
              ...
              >
                ...
                <div class="text-right">
                  <p class="font-semibold text-gray-900">{{ attempt.percentage }}%</p>
                  <p class="text-sm text-gray-600">
